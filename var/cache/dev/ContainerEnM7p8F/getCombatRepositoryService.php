 ...
 */
class getCombatRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CombatRepository' shared autowired service.
     *
     * @return \App\Repository\CombatRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CombatRepository.php';

        return $container->privates['App\\Repository\\CombatRepository'] = new \App\Repository\CombatRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
