 ...
 */
class getFightRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FightRepository' shared autowired service.
     *
     * @return \App\Repository\FightRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FightRepository.php';

        return $container->privates['App\\Repository\\FightRepository'] = new \App\Repository\FightRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
