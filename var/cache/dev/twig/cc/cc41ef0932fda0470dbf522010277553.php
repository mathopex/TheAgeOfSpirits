...
class __TwigTemplate_65ab8f8f6435520c2c3b57d35c545416 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "<body id=\"bg-contact\">
    <div id=\"contact-padding\">
        <div>
            <h1 id=\"h1-contact\">Contactez-Nous</h1>

            <p id=\"p-contact\">Nous vous répondrons sous 24 heures.</p>
        ...
        echo "
                ...
                ";
        // line 15
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 15, $this->source); })()), "motif", [], "any", false, false, false, 15), 'row');
        echo "
                ";
        // line 16
        ...
        echo "
                ";
        // line 17
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 17, $this->source); })()), "message", [], "any", false, false, false, 17), 'row');
        echo "
...
";
    ...
    {
        return array (  119 => 23,  110 => 17,  106 => 16,  102 => 15,  97 => 13,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "contact/contact.html.twig", "C:\\Users\\matho\\Desktop\\TheAgeOfSpirits\\templates\\contact\\contact.html.twig");
    }
}
